...
import static org.apache.spark.sql.types.MoreMath.ifNegative;
import static org.apache.spark.sql.types.MoreMath.unsignedBorrow;
import static org.apache.spark.sql.types.MoreMath.unsignedCarry;
import static org.apache.spark.sql.types.MoreMath.unsignedMultiplyHigh;
...
//    private static final ByteBuffer BIG_ENDIAN_BYTE_BUFFER = ByteBuffer.allocate(16).order(ByteOrder.BIG_ENDIAN);
    ...
    public static Int128 fromBigEndian(byte[] bytes)
    {
        if (bytes.length >= 16) {
            ...
            long low = byteBuffer.getLong(offset);

            offset -= Long.BYTES;
            long high = byteBuffer.getLong(offset);
            ...
            long high = byteBuffer.getLong(0);
            offset -= Long.BYTES;
    ...
    public void toBigEndianBytes(byte[] bytes, int offset)
    {
        ...
        byteBuffer.putLong(offset + Long.BYTES, low);
    }
    ...
    {
        return Int128Math.compare(a.getHigh(), a.getLow(), b.getHigh(), b.getLow());
    }
    ...
    {
        return new Int128(
                Int128Math.andHigh(a.getHigh(), a.getLow(), b.getHigh(), b.getLow()),
                Int128Math.andLow(a.getHigh(), a.getLow(), b.getHigh(), b.getLow()));
    }

    public static Int128 or(Int128 a, Int128 b)
    {
        return new Int128(
                Int128Math.orHigh(a.getHigh(), a.getLow(), b.getHigh(), b.getLow()),
                Int128Math.orLow(a.getHigh(), a.getLow(), b.getHigh(), b.getLow()));
    }

    public static Int128 xor(Int128 a, Int128 b)
    {
        return new Int128(
                Int128Math.xorHigh(a.getHigh(), a.getLow(), b.getHigh(), b.getLow()),
                Int128Math.xorLow(a.getHigh(), a.getLow(), b.getHigh(), b.getLow()));
    }

    public static Int128 not(Int128 value)
    {
        return new Int128(
                Int128Math.notHigh(value.getHigh(), value.getLow()),
                Int128Math.notLow(value.getHigh(), value.getLow()));
    }

    public static Int128 shiftRight(Int128 value, int shift)
    {
        return new Int128(
                Int128Math.shiftRightHigh(value.getHigh(), value.getLow(), shift),
                Int128Math.shiftRightLow(value.getHigh(), value.getLow(), shift));
    }

    public static Int128 shiftLeft(Int128 value, int shift)
    {
        return new Int128(
                Int128Math.shiftLeftHigh(value.getHigh(), value.getLow(), shift),
                Int128Math.shiftLeftLow(value.getHigh(), value.getLow(), shift));
    }

    public static Int128 shiftRightUnsigned(Int128 value, int shift)
    {
        return new Int128(
                Int128Math.shiftRightUnsignedHigh(value.getHigh(), value.getLow(), shift),
                Int128Math.shiftRightUnsignedLow(value.getHigh(), value.getLow(), shift));
    }

    public static int numberOfLeadingZeros(Int128 value)
    {
        return Int128Math.numberOfLeadingZeros(value.getHigh(), value.getLow());
    }

    public static int numberOfTrailingZeros(Int128 value)
    {
        return Int128Math.numberOfTrailingZeros(value.getHigh(), value.getLow());
    }

    public static int bitCount(Int128 value)
    {
        return Int128Math.bitCount(value.getHigh(), value.getLow());
    }
    ...
    {
        return new Int128(
                Int128Math.addHigh(a.getHigh(), a.getLow(), b.getHigh(), b.getLow()),
                Int128Math.addLow(a.getHigh(), a.getLow(), b.getHigh(), b.getLow()));
    }

    public static Int128 addExact(Int128 a, Int128 b)
    {
        return new Int128(
                Int128Math.addHighExact(a.getHigh(), a.getLow(), b.getHigh(), b.getLow()),
                Int128Math.addLowExact(a.getHigh(), a.getLow(), b.getHigh(), b.getLow()));
    }

    public static Int128 subtract(Int128 a, Int128 b)
    {
        return new Int128(
                Int128Math.subtractHigh(a.getHigh(), a.getLow(), b.getHigh(), b.getLow()),
                Int128Math.subtractLow(a.getHigh(), a.getLow(), b.getHigh(), b.getLow()));
    }

    public static Int128 subtractExact(Int128 a, Int128 b)
    {
        return new Int128(
                Int128Math.subtractHighExact(a.getHigh(), a.getLow(), b.getHigh(), b.getLow()),
                Int128Math.subtractLowExact(a.getHigh(), a.getLow(), b.getHigh(), b.getLow()));
    }
...
//        return Int128.valueOf(tmpHigh, tmpLow);
    ...
    {
        return new Int128(
                Int128Math.incrementHigh(value.getHigh(), value.getLow()),
                Int128Math.incrementLow(value.getHigh(), value.getLow()));
    }
    ...
    {
        return new Int128(
                Int128Math.decrementHigh(value.getHigh(), value.getLow()),
                Int128Math.decrementLow(value.getHigh(), value.getLow()));
    }
    ...
    {
        return new Int128(
                Int128Math.negateHigh(value.getHigh(), value.getLow()),
                Int128Math.negateLow(value.getHigh(), value.getLow()));
    }
    ...
    {
        return new Int128(
                Int128Math.multiplyHigh(a.getHigh(), a.getLow(), b.getHigh(), b.getLow()),
                Int128Math.multiplyLow(a.getHigh(), a.getLow(), b.getHigh(), b.getLow()));
    }

    public static Int128 multiplyExact(Int128 a, Int128 b)
    {
        long aLow = a.getLow();
        long aHigh = a.getHigh();
        long bLow = b.getLow();
        long bHigh = b.getHigh();
...
//
    ...
    {
        Int128Math.divide(dividend.getHigh(), dividend.getLow(), divisor.getHigh(), divisor.getLow(), quotient, remainder);
    }
